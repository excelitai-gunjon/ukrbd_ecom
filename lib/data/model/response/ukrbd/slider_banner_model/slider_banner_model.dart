...
SliderBannerModel sliderBannerModelFromJson(dynamic str) => SliderBannerModel.fromJson(json.decode(str));
dynamic sliderBannerModelToJson(SliderBannerModel data) => json.encode(data.toJson());
